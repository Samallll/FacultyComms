...
public class UserDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_PARENT = "CREATE TABLE " + TABLE_PARENT + "(" + KEY_ROLL_NUMBER + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_STUDENT_NAME + " TEXT, " + KEY_MOBILE + "INTEGER," + KEY_EMAIL_ID + "TEXT," + KEY_DEGREE + "TEXT," + KEY_PARENT_NAME + "TEXT," + KEY_USER_NAME + "TEXT," + KEY_PASSWORD + "TEXT);";
